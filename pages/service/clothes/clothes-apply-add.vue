	...
	<view class="container p15 ">
		...
		<view class="field-box whiteBg radius4 p15 pt5 pb5 mt15">
			<u--form labelPosition="left" :model="applyInfo" :rules="rules" ref="applyInfoRef">
				...
				<u-form-item class="textarea-full" label="申请原因" prop="reason" labelWidth="80" ref="item3">
					<u--textarea placeholder="请输入申请原因" maxlength="200" v-model="applyInfo.reason" count></u--textarea>
				</u-form-item>
			</u--form>
